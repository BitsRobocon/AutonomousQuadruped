""" This file implements the gym environment of VrkaMicro with Bezier Curve.
"""
import math
import time
import gym
...
class vrkaBezierEnv(vrkaGymEnv):
  ...
  """
    ...
    def __init__(self,
        ...
        super(vrkaBezierEnv, self).__init__(
    ...
    """
        ...
        self.pass_joint_angles(self.ja)
        action = self.ja
    ...
    def _reward(self):
        ...
        DesiredVelicty = math.copysign(self.vrka.StepVelocity / 4.0,
                                       self.vrka.StepLength)

        fwd_speed = self.vrka.prev_lin_twist[0]  # vx
        lat_speed = self.vrka.prev_lin_twist[1]  # vy

        # DEBUG
        lt, at = self.vrka.GetBaseTwist()
