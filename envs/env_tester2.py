...
def main():
    ...
    while t < (int(max_timesteps)):
        ...
        FL_phases.append(env.vrka.LegPhases[0])
        FR_phases.append(env.vrka.LegPhases[1])
        BL_phases.append(env.vrka.LegPhases[2])
        BR_phases.append(env.vrka.LegPhases[3])
        ...
        env.vrka.GetExternalObservations(bzg, bz_step)
        # Step
